        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl z-50">
          ...
          <div className="px-6 pb-8">
            ...
            <div className="space-y-3 bg-gray-50 rounded-xl p-4">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-[var(--text-muted)]">획득 조건</span>
                <span className="text-[var(--primary)] font-medium">
    ...
    >
      <div className="relative">
        <div
          className={cn(
            ...
            badge.isUnlocked
              ? 'bg-white shadow-md border border-[var(--border)]'
        ...
        {!badge.isUnlocked && (
          <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gray-400 rounded-full flex items-center justify-center shadow-sm">
      ...
      <span
        className={cn(
          ...
          badge.isUnlocked ? 'text-[var(--primary)]' : 'text-[var(--text-muted)]'
        )}
      >
        {badge.name}
      </span>
  ...
  return (
    <div className="pb-8">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-[var(--primary)]">뱃지 컬렉션</h1>
      ...
      {loading && badges.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-sm text-[var(--text-muted)]">뱃지를 불러오는 중...</p>
        </div>
      )}
